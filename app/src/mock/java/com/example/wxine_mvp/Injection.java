 ...
 * {@link InfosDataSource} at compile time. This is useful for testing, since it allows us to use
 * a fake instance of the class to isolate the dependencies and run a test hermetically.
 */
public class Injection {

    public static InfosRepository provideInfosRepository(@NonNull Context context) {
        checkNotNull(context);
        return InfosRepository.getInstance(FakeInfosRemoteDataSource.getInstance(),
